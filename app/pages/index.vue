  ...
  <div class="min-h-screen bg-background text-text-primary">
    <div class="container px-6 py-16 mx-auto">
      <div class="mb-16 text-center">
        <h1 class="mb-6 text-5xl font-bold text-primary">
          Brand Router Engine
        </h1>
        <p class="mx-auto max-w-3xl text-xl text-text-secondary">
          A powerful multi-theme website engine with dynamic brand switching and
          design token integration.
        </p>
      </div>

      <div
        class="grid grid-cols-1 gap-8 mx-auto max-w-6xl md:grid-cols-2 lg:grid-cols-3"
      >
        <!-- Brand cards -->
        <div
        ...
        <div class="p-8 mx-auto max-w-4xl rounded-xl bg-surface">
          ...
          <div class="grid grid-cols-1 gap-6 text-left md:grid-cols-2">
            <div class="flex items-start space-x-3">
              <div
                class="flex flex-shrink-0 justify-center items-center mt-1 w-6 h-6 text-white rounded-full bg-accent"
              >
              ...
              <div>
                ...
                <p class="text-sm text-text-secondary">
                  Route-based brand theme changes with CSS variables
                </p>
              </div>
            </div>
            <div class="flex items-start space-x-3">
              ...
              <div>
                ...
                <p class="text-sm text-text-secondary">
                  Centralized design tokens with Tailwind integration
                </p>
              </div>
            </div>
            <div class="flex items-start space-x-3">
            ...
            <div class="flex items-start space-x-3">
              ...
              <div>
                ...
                <p class="text-sm text-text-secondary">
                  Easy brand setup with JSON configuration
                </p>
              </div>
            </div>
          </div>
