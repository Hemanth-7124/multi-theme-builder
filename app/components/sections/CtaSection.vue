<template>
  <section class="py-20 cta-section">
    <div class="container px-6 mx-auto text-center">
      <h2 class="mb-6 text-3xl font-bold md:text-4xl" style="color: var(--color-text-inverse);">
        {{ content.title }}
      </h2>
      ...
      <div class="flex flex-col gap-4 justify-center sm:flex-row">
        <button
          ...
          class="px-8 py-4 text-lg font-semibold rounded-lg transition-colors"
        ...
        <button
          ...
          class="px-8 py-4 text-lg font-semibold rounded-lg border-2 transition-colors"
